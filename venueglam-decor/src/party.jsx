    ...
    <div className="venuglam-container">
      ...
      <main className="main-content">
        <div className="page-header">
          <h1>Find the Best Party Decor Services</h1>
          <p className="description">
            Browse top Party decoration services in Lahore, Karachi, Islamabad, and Rawalpindi to make your events unforgettable!
          </p>
        </div>
              ...
              {[
                {
                  ...
                  image: "/partydecor1.jpg",
                  description:
                    "We offer theme-based Party decorations with customized balloon setups, cake tables, and lighting.",
                },
                {
                  name: "Orignal Decors",
                  rating: "4.8 (22)",
                  ...
                  contact: "📞 Contact: 0303-4844244",
                  image: "/partydecor2.jpg",
                  description:
                    "Affordable Party event decor with backdrops, themed arrangements, and LED lighting.",
                },
              ].map((vendor, index) => (
