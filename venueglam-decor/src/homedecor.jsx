    ...
    <div className="venuglam-container">
      ...
      <main className="main-content">
        <div className="page-header">
          <h1>Find the Best HOME Decor Services</h1>
          <p className="description">
            Browse top Home decoration services in Lahore, Karachi, Islamabad, and Rawalpindi to make your events unforgettable!
          </p>
        </div>
              ...
              {[
                {
                  ...
                  image: "/homedecor1.jpg",
                  description:
                    "We offer theme-based HOME decorations with customized balloon setups, cake tables, and lighting.",
                },
                {
                  name: " Best Decors",
                  rating: "4.8 (22)",
                  location: "Haveli, Rawalpindi",
                  price: "Starting at PKR 30,000",
                  contact: "📞 Contact: 0303-4844244",
                  image: "/homedecor2.jpg",
                  description:
                    "Affordable Home event decor with backdrops, themed arrangements, and LED lighting.",
                },
              ].map((vendor, index) => (
