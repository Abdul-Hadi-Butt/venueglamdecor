    ...
    <div className="venuglam-container">
      ...
      <main className="main-content">
        <div className="page-header">
          <h1>Find the Best Engagment Decor Services</h1>
          <p className="description">
            Browse top Engagment decoration services in Lahore, Karachi, Islamabad, and Rawalpindi to make your events unforgettable!
          </p>
        </div>
              ...
              {[
                {
                  ...
                  image: "/engagmentdecor1.jpg",
                  description:
                    "We offer theme-based Engagment decorations with customized balloon setups, cake tables, and lighting.",
                },
                {
                  name: "Orignal Decors",
                  rating: "4.8 (22)",
                  ...
                  contact: "📞 Contact: 0303-4844244",
                  image: "/engagmentdecor2.jpg",
                  description:
                    "Affordable Engagment event decor with backdrops, themed arrangements, and LED lighting.",
                },
              ].map((vendor, index) => (
