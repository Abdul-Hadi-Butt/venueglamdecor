...
export default function GraduationDecor() {
              ...
              {[
                {
                  ...
                  image: "/graduationdecor1.jpg",
                  description:
                    "We offer theme-based Graduation decorations with customized balloon setups, cake tables, and lighting.",
                },
                {
                  name: "Orignal Decors",
                  rating: "4.8 (22)",
                  ...
                  contact: "📞 Contact: 0303-4844244",
                  image: "/graduationdecor2.jpg",
                  description:
                    "Affordable Graduation event decor with backdrops, themed arrangements, and LED lighting.",
                },
              ].map((vendor, index) => (
